...
class IndexController extends AdminController
{
    ...
    public function index()
    {
        ...
        $cacheKey = 'admin_menus_' . uniacid() . '_' . cmf_get_current_admin_id();
        $menus          = cache($cacheKey, '', null, 'admin_menus');

        if (empty($menus)) {
            $menus = $adminMenuModel->menuTree();
            cache($cacheKey, $menus, null, 'admin_menus');
        }
        ...
        $portal = Db::table('g_portal')->where('id', uniacid())->find();
